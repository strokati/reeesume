...
export const SAMPLE_RESUME_DATA: ResumeData = {
	...
	certifications: [
		{ name: 'AWS Solutions Architect – Associate', issuer: 'Amazon Web Services', issueDate: '2022-08' },
	...
	projects: [
		{
			name: 'OpenCLI',
			description: 'A developer-friendly CLI framework for building modern command-line tools with auto-generated help and shell completions.',
		...
		},
		{
			...
			description: 'Interactive data visualization dashboard for real-time analytics with customizable widgets.',
			role: 'Lead Developer',
	...
	volunteering: [
		{
			...
			startDate: '2020-01',
			endDate: '',
			responsibilities: ['Teach web development fundamentals to underrepresented youth', 'Develop curriculum for HTML, CSS, and JavaScript workshops'],
		},
	],
	publications: [
		{
