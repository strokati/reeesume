									...
									<CardContent className="p-4 space-y-2">
										<div className="flex items-center justify-between">
											...
											<Badge
												className={cn(
													...
													docStatusStyles[row.resumeStatus],
												)}
											>
										...
										<div className="flex gap-2">
											<Button
												...
												variant="outline"
												onClick={() =>
													router.push(`/applications/${row.id}/resume`)
												}
											>
												Open Editor
											</Button>
											{row.resumeStatus !== 'none' && (
												<Button
													...
													onClick={() =>
														router.push(
															`/api/export?draftId=${row.id}&format=pdf`,
														)
													}
												>
													Export
								...
								<Card>
									<CardContent className="p-4 space-y-2">
										...
										<Button
											...
											onClick={() =>
												router.push(
													`/applications/${row.id}/cover-letter`,
												)
											}
										>
											Open Editor
								...
								<div className="space-y-2 text-sm">
									...
									{(row.salaryMin != null || row.salaryMax != null) && (
										<div className="flex items-center gap-2">
											...
											<span>
												{row.salaryMin != null &&
													`$${row.salaryMin.toLocaleString()}`}
												{row.salaryMin != null && row.salaryMax != null && ' – '}
												{row.salaryMax != null &&
													`$${row.salaryMax.toLocaleString()}`}
											</span>
										</div>
									)}
									{row.sourceUrl && (
