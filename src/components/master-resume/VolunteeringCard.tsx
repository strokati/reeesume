...
export function VolunteeringCard({
  ...
  volunteeringRole: VolunteeringRole;
  resumeId: string;
  ...
  function handleDelete() {
    startTransition(async () => {
      try {
        await deleteVolunteeringRole(volunteeringRole.id);
  ...
  const dateRange = [volunteeringRole.startDate, volunteeringRole.endDate ?? 'Current']
    .filter(Boolean)
    .join(' – ');
